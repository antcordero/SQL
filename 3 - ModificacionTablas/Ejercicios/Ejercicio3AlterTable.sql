...
/*Ejercicio 1.- Añade una nueva columna (no nula) “Ciudad” a la tabla ALUMNO 
de tipo caracteres (máximo 15 caracteres) que por defecto tenga “Malaga” como valor. */

alter table alumno
add column ciudad varchar(15) default "Malaga" not null;
...
alter table alumno
modify ciudad varchar(25) default "Málaga";
...
/*Ejercicio 5.- Añade una nueva columna “Media” en la tabla ALUMNO que 
...
/*Ejercicio 6.- Modifica la columna “Media” para que acepte 
...
/*Ejercicio 7.- Elimina la restricción de clave foránea 
de la columna Grado de la tabla ALUMNO.*/

alter table alumno
drop constraint fk_id_grado;

/*Ejercicio 8.- Elimina la restricción de clave primaria 
de la columna DNI de la tabla ALUMNO.*/
...
/*Ejercicio 10.- Añade una clave primaria a la tabla ALUMNO 
...
/*Ejercicio 11.- Añade una restricción a la columna Nombre de la tabla 
