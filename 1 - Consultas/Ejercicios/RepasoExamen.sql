...
salario INT NOT NULL, comision FLOAT NOT NULL, 
cargo VARCHAR( 15 ) NOT NULL, jefeID VARCHAR( 12 ), 
...
/*Ejercicio 1.- Obtener el nombre, cargo, salario de todos los empleados, 
siempre que el salario sea superior a 800.000 y el cargo sea “Vendedor”, 
ordenado por el salario (de mayor a menor). 
Muestra el valor del salario en dolares y en una columna llamada DOLARES.
...
/*Ejercicio 2.- Obtener los nombres de los empleados cuya comisión sea
 menor o igual que el 30% de su salario en una columna llamada “Privilegiados”.
...
/*Ejercicio 3.- Obtener el nombre, fecha de nacimiento y cargo de los empleados 
cuyo nombre tenga entre 10 y 15 caracteres (ambos no incluidos), 
o que en 2023 hayan cumplido 20 o más años desde su incorporación a la empresa.
 Ordena los resultados por orden alfabético por el nombre de los empleados. */
...
del departamento “MERCADEO”, siempre y cuando el nombre de la ciudad del departamento 
contenga alguna de las vocales "i", "a" o "e". 
...
de VENTAS ni en el departamento de MANTENIMIENTO. 
Muestra los resultados en columnas denominadas como “Nºtotal” y “MediaSalario”.*/
